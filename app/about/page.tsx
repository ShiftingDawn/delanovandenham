        ...
        <Page title={"About me"}>
            ...
            <article>
                ...
                <div className={"mt-8 flex flex-col gap-4"}>
                    <p>
                        I&apos;m a software developer who enjoys building things that are both useful and enjoyable to
                        use.
                        ...
                        and <MarkedText href={"https://tailwindcss.com/"}>TailwindCSS</MarkedText>, turning ideas into
                        fast,
                    ...
                    <p>
                        ...
                        href={"https://www.mysql.com/"}>MySQL</MarkedText>, and I enjoy designing reliable backends just
                        as
                        much as crafting great user interfaces.
                    </p>
                    <p>
                        <MarkedText href={"https://www.java.com/"}>Java</MarkedText>&nbsp;is where I have the deepest
                        roots.
                        With over 10 years of
                        experience, it&apos;s the language that taught me how to build software that lasts, and I still
                        take
                        pride in writing clean, maintainable code.
                    </p>
                    <p>
                        I&apos;m always looking for opportunities to learn, improve, and create software that makes a
                        real
                        difference.
                    </p>
                </div>
            ...
            <article>
                ...
                <div className={"flex flex-col gap-4"}>
                    <p>
                        Outside of development, I spend a lot of my free time gaming and tinkering with computer
                        hardware.
